...
-- Results from this query are taken to Tableau
SELECT * FROM dbo.Books ORDER BY Title DESC;
...
-- Results here are sent to Tableau
...
-- Also, replacing whitespace with _ allows for the parse function to work even with empty comma spaces.
UPDATE BookUsers
